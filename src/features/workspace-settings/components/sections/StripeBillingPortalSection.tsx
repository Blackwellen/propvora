...
export interface StripeBillingPortalSectionProps {}

export function StripeBillingPortalSection(_props: StripeBillingPortalSectionProps) {
  return (
...
export default StripeBillingPortalSection
