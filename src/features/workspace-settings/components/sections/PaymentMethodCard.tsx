  ...
  return (
    <div className="bg-white rounded-2xl border border-slate-200 p-5 mb-5">
      ...
      <p className="text-[12.5px] text-slate-500 mb-4">
        Cards and payment methods are stored securely by Stripe. Add, update or remove a card from
        the Stripe billing portal — Propvora never sees your full card details.
      </p>
      <button
        type="button"
        onClick={async () => {
