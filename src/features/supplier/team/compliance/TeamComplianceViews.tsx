...
const EXPIRY: ExpiryItem[] = [
  { id: "x1", name: "Public liability insurance", kind: "Insurance", owner: "Workspace", expiresAt: days(-4), blocksService: "All services" },
  { id: "x2", name: "Gas Safe — John Parker", kind: "Licence", owner: "John Parker", expiresAt: days(14), blocksService: "Gas services" },
  { id: "x3", name: "NICEIC accreditation", kind: "Accreditation", owner: "Workspace", expiresAt: days(48), blocksService: null },
  { id: "x4", name: "DBS — Sarah Ahmed", kind: "Document", owner: "Sarah Ahmed", expiresAt: days(120), blocksService: null },
]
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        ...
        <Mini label="Blocked services" value="1" tone="red" />
        <Mini label="Compliance score" value="91" tone="emerald" />
      </div>
...
const ACCREDS: Accred[] = [
  { id: "ac1", name: "CHAS Elite", body: "CHAS", expiresAt: days(220), status: "verified", linkedServices: 4, publicBadge: true },
  { id: "ac2", name: "Gas Safe Registered", body: "Gas Safe Register", expiresAt: days(315), status: "verified", linkedServices: 2, publicBadge: true },
  { id: "ac3", name: "NICEIC Approved", body: "NICEIC", expiresAt: days(48), status: "pending_review", linkedServices: 1, publicBadge: false },
  { id: "ac4", name: "TrustMark", body: "TrustMark", expiresAt: days(-10), status: "expired", linkedServices: 0, publicBadge: false },
]
...
const CHECKS: WorkerCheck[] = [
  { id: "c1", name: "Jake Foster", initials: "JF", trade: "Gas", gasSafe: true, dbs: true, rightToWork: true, training: true, blocked: null, expiresSoon: false },
  { id: "c2", name: "Mike Thompson", initials: "MT", trade: "Plumbing", gasSafe: false, dbs: true, rightToWork: true, training: true, blocked: null, expiresSoon: false },
  { id: "c3", name: "Emma Collins", initials: "EC", trade: "Electrical", gasSafe: false, dbs: true, rightToWork: true, training: false, blocked: null, expiresSoon: true },
  { id: "c4", name: "Sarah Ahmed", initials: "SA", trade: "Multi-trade", gasSafe: false, dbs: false, rightToWork: true, training: true, blocked: "Gas jobs", expiresSoon: false },
  { id: "c5", name: "John Parker", initials: "JP", trade: "Gas", gasSafe: true, dbs: true, rightToWork: true, training: true, blocked: null, expiresSoon: true },
]
export function TeamChecks() {
  const [toast, setToast] = useState<string | null>(null)
  const [sel, setSel] = useState<WorkerCheck>(CHECKS[3])
  return (
    <div className="space-y-4">
      {toast && <SupplierBanner tone="emerald" onDismiss={() => setToast(null)}>{toast}</SupplierBanner>}
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
