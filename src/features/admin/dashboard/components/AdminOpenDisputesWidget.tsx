...
export function AdminOpenDisputesWidget({ disputes }: Props) {
  return (
    <AdminQueuePanel title="Open disputes" icon={AlertCircle} count={disputes.length} viewAllHref="/admin/marketplace/disputes">
      {disputes.length === 0 ? (
