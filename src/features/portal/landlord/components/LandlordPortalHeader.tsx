...
import { Building2, Wallet, Wrench, MessageSquare, Home } from "lucide-react"

interface LandlordPortalHeaderProps {
  base: string
...
const NAV_LINKS = [
  { label: "Portfolio", segment: "", icon: Home },
...
export function LandlordPortalHeader({
  base,
  workspaceName,
  displayName,
}: LandlordPortalHeaderProps) {
  return (
