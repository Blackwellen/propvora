...
import SubmitInvoiceForm from "@/app/(portal)/portal/[sessionId]/supplier/invoices/SubmitInvoiceForm"

const STATUS_FILTERS = ["All", "Submitted", "Reviewing", "Approved", "Paid", "Rejected"] as const

interface SupplierPortalInvoicesTabProps {
  invoices: SupplierInvoice[]
  session: { id: string }
  jobs: SupplierJob[]
}

export function SupplierPortalInvoicesTab({
  invoices: initialInvoices,
  session,
  jobs,
}: SupplierPortalInvoicesTabProps) {
