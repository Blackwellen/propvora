  ...
  return (
    <Panel title="Privacy">
      ...
      <div className="pt-2 mt-2 border-t border-slate-100">
        <button
          onClick={() => toast("Account deletion — opens secure flow", "warning")}
          className="inline-flex items-center gap-1.5 text-[12.5px] font-semibold text-rose-600"
        >
          <Trash2 className="w-4 h-4" /> Delete / export account
        </button>
      </div>
    </Panel>
  )
