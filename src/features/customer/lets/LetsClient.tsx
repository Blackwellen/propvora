...
export default function LetsClient({ initialTab = "search" }: { initialTab?: string }) {
  ...
  function changeTab(id: string) {
    setTab(id)
    router.replace(id === "search" ? "/customer/lets" : `/customer/lets?tab=${id}`, { scroll: false })
  }
