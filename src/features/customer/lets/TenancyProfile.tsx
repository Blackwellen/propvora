          ...
          {tab === "setup" && (
            <>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <Card title="Occupants" icon={Users}><p className="text-[12.5px] text-slate-700">Sarah Johnson <span className="text-[10.5px] text-slate-400">(lead tenant)</span></p><p className="text-[11.5px] text-slate-400 mt-1">1 adult household</p></Card>
