...
export function StepDocuments() {
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="border-2 border-dashed border-slate-200 rounded-2xl p-10 text-center hover:border-[var(--brand)]/50 hover:bg-[var(--brand-soft)]/30 transition-all cursor-pointer">
