    ...
    <section className="py-7 border-b border-slate-200">
      ...
      <div className="flex items-start gap-5">
        <div className="shrink-0">
          <div className="w-16 h-16 rounded-full bg-gradient-to-br from-[var(--brand)]/20 to-[var(--brand-strong)]/30 flex items-center justify-center text-[var(--brand-strong)] font-bold text-[22px] ring-2 ring-white shadow-md">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="mt-3 flex flex-wrap items-center gap-3">
            ...
            <span className="inline-flex items-center gap-1.5 text-[12.5px] font-semibold text-[var(--brand-strong)] bg-[var(--brand-soft)] px-2.5 py-1 rounded-full">
