...
// Client list: receives server-scoped jobs as props and only does local
// search/filter. No data fetching happens here — the server already scoped it.
export default function JobsList({ jobs, base }: { jobs: SupplierJob[]; base: string }) {
