...
// Honest terminal-state notice for the recipient share surface (expired /
// revoked / invalid / disabled). Generic copy — never reveals whether a token
// existed or why exactly it failed, to avoid enumeration.
    ...
    <main className="min-h-screen flex flex-col items-center justify-center px-6">
      <div className="w-full max-w-sm rounded-2xl bg-white border border-slate-200 shadow-sm p-8 text-center">
        <div className="relative h-7 w-[140px] mx-auto mb-6">
          <Image src="/propvora-logo-dark.png" alt="Propvora" fill className="object-contain" priority />
        </div>
        <div className={`w-12 h-12 rounded-full ${toneCls} flex items-center justify-center mx-auto mb-4`}>
