  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl border border-[#E2E8F0] shadow-sm overflow-hidden">
        {loading ? (
          <div className="p-12 text-center text-slate-400 text-sm">Computing trial balance…</div>
        ) : !tb || tb.rows.length === 0 ? (
          <div className="p-12 flex flex-col items-center gap-3 text-center">
            ...
            <p className="text-xs text-slate-400 max-w-sm">Post some journal entries and they will appear here, summed from the ledger.</p>
          </div>
        ) : (
