    ...
    <div className="flex flex-col min-h-screen bg-slate-50">
      ...
      <div className="hidden md:flex px-6 py-3 bg-white border-b border-slate-200 items-center gap-3 flex-wrap">
        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          <Link href="/app/calendar/events/new" className="flex items-center gap-1.5 text-[12px] px-3 py-1.5 rounded-md bg-blue-600 text-white hover:bg-blue-700 font-medium">
      ...
      <div className="hidden md:flex flex-1 overflow-hidden flex-col lg:flex-row">
        ...
        <div className="w-full lg:w-72 shrink-0 overflow-y-auto bg-slate-50 p-4 flex flex-col gap-4">
          ...
          <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-4">
            ...
            <div className="flex flex-col gap-2">
              <Link href="/app/calendar/events/new" className="flex items-center gap-2 w-full px-3 py-2 rounded-lg bg-blue-600 text-white text-[12px] font-semibold hover:bg-blue-700 transition-colors">
                <Plus className="w-3.5 h-3.5" />New Event
              </Link>
              <Link href="/app/calendar/reminders/new" className="flex items-center gap-2 w-full px-3 py-2 rounded-lg border border-slate-200 text-slate-700 text-[12px] font-medium hover:bg-slate-50 transition-colors">
                <Bell className="w-3.5 h-3.5 text-slate-500" />New Reminder
              </Link>
              <Link href="/app/calendar/views/month" className="flex items-center gap-2 w-full px-3 py-2 rounded-lg border border-slate-200 text-slate-700 text-[12px] font-medium hover:bg-slate-50 transition-colors">
