        ...
        {EVENT_TYPE_OPTIONS.map(opt => {
          ...
          return (
            ...
            >
              ...
              <p className={cn("text-sm font-semibold", active ? "text-[var(--brand)]" : "text-slate-800")}>{opt.label}</p>
    ...
    <div className="space-y-5">
      ...
      <div className="flex items-center justify-between p-4 rounded-xl border border-slate-200 bg-slate-50">
        ...
        <button
          ...
          className={cn(
            "w-11 h-6 rounded-full transition-colors relative focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--brand)]/40",
            form.allDay ? "bg-[var(--brand)]" : "bg-slate-300"
          )}
        >
      ...
      {!form.allDay && (
        <div className="flex items-center gap-2 p-3 rounded-xl bg-[var(--brand-soft)] border border-[#BFDBFE]">
          <Clock className="w-4 h-4 text-[var(--brand)] shrink-0" />
          <span className="text-sm text-[var(--brand)] font-medium">Duration: {duration}</span>
        </div>
      )}
    </div>
  )
...
function Step4({ form, setForm }: { form: FormData; setForm: (f: FormData) => void }) {
  return (
    <div className="space-y-5">
      ...
      <div className="rounded-xl border border-slate-200 bg-white p-4 space-y-4">
        <div className="flex items-center gap-2 mb-1">
          <Repeat className="w-4 h-4 text-[var(--brand)]" />
    ...
    <div className="space-y-5">
      ...
      <div>
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full h-9 pl-8 pr-3 rounded-lg text-sm border border-slate-200 focus:outline-none focus:ring-2 focus:ring-[var(--brand)]/30 focus:border-[var(--brand)] bg-white"
          />
        </div>
      </div>
      ...
      <div>
        ...
        <textarea
          ...
          rows={3}
          className="w-full px-3 py-2 rounded-lg text-sm border border-slate-200 focus:outline-none focus:ring-2 focus:ring-[var(--brand)]/30 focus:border-[var(--brand)] bg-white resize-none"
        />
      </div>
      ...
      <div className="space-y-2">
        {[
          ...
          <div key={row.label} className="flex items-center justify-between py-2 border-b border-slate-100">
            ...
            <button onClick={() => goTo(row.step)} className="text-xs text-[var(--brand)] hover:underline shrink-0">Edit</button>
          </div>
        ))}
      </div>
    </div>
      ...
      {step >= 4 && (
        <div className="rounded-xl border border-slate-200 bg-white p-4 space-y-2">
          <div className="flex items-center gap-2">
            <Bell className="w-3.5 h-3.5 text-[var(--brand)]" />
  ...
  return (
    <div className="space-y-0">
      ...
      <div className="h-1 bg-slate-200">
        <div className="h-1 bg-[var(--brand)] transition-all duration-300" style={{ width: `${progress}%` }} />
      </div>
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  active ? "bg-[var(--brand-soft)] text-[var(--brand)] font-semibold" :
              ...
              >
                ...
                <div className="min-w-0">
                  <div className={cn("text-xs font-medium truncate", active ? "text-[var(--brand)]" : done ? "text-slate-700" : "text-slate-400")}>{s.label}</div>
                </div>
                {active && <Icon className="w-3.5 h-3.5 ml-auto shrink-0 text-[var(--brand)]" />}
              </button>
            )
          })}
        </div>
