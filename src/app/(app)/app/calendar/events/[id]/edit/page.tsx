    ...
    <div className="space-y-0 pb-32 lg:pb-24">
      ...
      <div className="hidden md:block px-6 pt-5 pb-0">
        <nav className="flex items-center gap-1.5 text-xs text-slate-500">
          ...
          <a href={sectionLink(`/property-manager/calendar/events/${id}`)} className="hover:text-[var(--brand)]">{form.title || "Event"}</a>
          <ChevronRight className="w-3 h-3" />
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between p-3 rounded-xl border border-slate-200 bg-slate-50">
              ...
              <button
                ...
                className={cn("w-11 h-6 rounded-full transition-colors relative", form.allDay ? "bg-[var(--brand)]" : "bg-slate-300")}
              >
