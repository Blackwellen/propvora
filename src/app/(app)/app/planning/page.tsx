  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 mb-8">
        ...
        <KpiCard label="Avg Net / Month" value={isLoading ? "—" : money(avgNet)} subtitle="across sets" icon={TrendingUp} iconColour="#10B981" />
        <KpiCard label="Best Net Yield" value={isLoading ? "—" : bestYieldSet && bestYieldSet.net_yield > 0 ? `${bestYieldSet.net_yield.toFixed(1)}%` : "0%"} subtitle={bestYieldSet?.title ? bestYieldSet.title.slice(0, 22) : undefined} icon={BarChart2} iconColour="#2563EB" />
