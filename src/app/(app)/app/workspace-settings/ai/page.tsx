...
export default function AIPage() {
  ...
  return (
    <div className="relative pb-20">
      ...
      {/* Usage / credits — honestly flagged as billing-dependent */}
      <div className="bg-white rounded-2xl border border-slate-200 p-5 mb-5">
        <div className="flex items-center justify-between">
          <div>
            <h3 className="text-[14px] font-bold text-slate-900">AI Credits & Usage</h3>
            <p className="text-[12px] text-slate-500 mt-0.5">Usage metering and credit top-ups require the billing integration.</p>
          </div>
          <button
            disabled
