...
export default function LongTermRentalsMapPage() {
  const [rentals, setRentals] = useState<PublicLongTermRental[]>(SEED_LONG_TERM_RENTALS)
    ...
    <PublicPageShell className="flex-1 flex flex-col overflow-hidden">
      ...
      <div className="flex flex-1 overflow-hidden" style={{ height: 'calc(100vh - 200px)' }}>
        ...
        <div className="flex-1 relative">
          <LongTermRentalMap rentals={rentals} basePath="/stays/long-term" />
          {/* Info bubble */}
