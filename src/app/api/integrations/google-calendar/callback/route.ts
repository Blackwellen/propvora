// OAuth callback for Google Calendar. Exchanges the authorisation code
...
export async function GET(req: Request) {
  ...
  return Response.redirect(`${appUrl}/property-manager/automations?integration=google_calendar&status=pending_token_exchange`)
}
