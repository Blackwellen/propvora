...
export const metadata: Metadata = {
  ...
  description:
    'Find vetted and insured property service providers — plumbers, electricians, gas engineers, cleaners and more across the UK.',
  openGraph: {
...
const FILTER_CHIPS = [
  ...
  { label: 'Emergency 24h', value: 'emergency' },
...
export default async function ProvidersPage() {
  ...
  return (
    <PublicPageShell>
      {/* Hero */}
      <section className="pt-8 pb-10 px-4 bg-gradient-to-b from-violet-50 to-white">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-4 divide-y sm:divide-y-0 sm:divide-x divide-slate-200">
              <div className="flex items-center gap-2 px-4 py-3.5 sm:col-span-2">
                ...
                <div className="flex-1 min-w-0">
                  <div className="text-xs font-semibold text-slate-500 uppercase tracking-wide">Trade or business</div>
                  <input
                    type="text"
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        {featuredProviders.length > 0 && (
          <div className="mb-10">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-xl font-bold text-slate-900">Featured providers</h2>
              <span className="text-sm text-blue-600 font-medium">{featuredProviders.length} featured</span>
            </div>
        ...
        <div className="flex items-center justify-between gap-4 mb-6">
          <p className="text-sm text-slate-600 font-medium">
            <span className="text-slate-900 font-bold">{allProviders.length}</span> providers
          </p>
