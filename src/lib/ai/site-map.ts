...
export const SITE_WIZARDS: SiteWizard[] = [
  ...
  { keywords: ["new ppm", "ppm schedule", "schedule ppm", "planned maintenance schedule"], route: "/property-manager/work/ppm/schedules/new", label: "New PPM schedule", action: "Schedule PPM", section: "Work" },
  ...
  { keywords: ["add income", "record income", "log income"], route: "/property-manager/money/income?new=1", label: "Add income", action: "Add income", section: "Money" },
  { keywords: ["add expense", "record expense", "log expense"], route: "/property-manager/money/expenses?new=1", label: "Add expense", action: "Add an expense", section: "Money" },
  ...
  { keywords: ["track deposit", "new deposit", "protect deposit"], route: "/property-manager/money/deposits?new=1", label: "Track deposit", action: "Track a deposit", section: "Money" },
