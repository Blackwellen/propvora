...
export const BOOKING_MODULES: BookingModule[] = [
  { key: "dashboard", label: "Dashboard", href: "/app/bookings", icon: BarChart3, summary: "Arrivals, revenue, risk and operations health.", phase: "live" },
  { key: "calendar", label: "Calendar", href: "/app/bookings/calendar", icon: CalendarDays, summary: "Month, week, timeline and listing-grid planning.", phase: "live" },
  { key: "listings", label: "Listings", href: "/app/bookings/listings", icon: Home, summary: "Booking listings separate from property records.", phase: "live" },
  { key: "availability", label: "Availability", href: "/app/bookings/availability", icon: CalendarRange, summary: "Blocks, holds, buffers, min nights and conflict rules.", phase: "foundation" },
  { key: "pricing", label: "Pricing", href: "/app/bookings/pricing", icon: Tags, summary: "Nightly, seasonal, fees, deposits and tax profiles.", phase: "foundation" },
  { key: "reservations", label: "Reservations", href: "/app/bookings/reservations", icon: BedDouble, summary: "Approvals, modifications, cancellations and registers.", phase: "live" },
  { key: "guests", label: "Guests / Customers", href: "/app/bookings/guests", icon: Users, summary: "Guest CRM, identity status and stay history.", phase: "foundation" },
  { key: "payments", label: "Payments & Deposits", href: "/app/bookings/payments", icon: CreditCard, summary: "Payment status, deposits, refunds, payouts and ledger links.", phase: "foundation" },
  { key: "messages", label: "Messages", href: "/app/bookings/messages", icon: MessageSquare, summary: "Guest, automated and internal stay messaging.", phase: "ops" },
  { key: "check-in", label: "Check-in / Checkout", href: "/app/bookings/check-in", icon: KeyRound, summary: "Access methods, release gates and checkout inspection.", phase: "ops" },
  { key: "rules", label: "House Rules", href: "/app/bookings/rules", icon: ShieldCheck, summary: "House rules, policies and legal acceptance snapshots.", phase: "legal" },
  { key: "cleaning", label: "Cleaning & Turnover", href: "/app/bookings/cleaning", icon: ClipboardCheck, summary: "Turnover tasks, linen, inspection and cleaner schedule.", phase: "ops" },
  { key: "maintenance", label: "Maintenance During Stay", href: "/app/bookings/maintenance", icon: Wrench, summary: "In-stay jobs, emergency callouts and supplier dispatch.", phase: "ops" },
  { key: "issues", label: "Issues & Claims", href: "/app/bookings/issues", icon: LifeBuoy, summary: "Issue triage, evidence, disputes, refunds and damage claims.", phase: "foundation" },
  { key: "reviews", label: "Reviews", href: "/app/bookings/reviews", icon: Star, summary: "Guest reviews, private feedback and rating quality.", phase: "foundation" },
  { key: "channel-sync", label: "Channel Sync", href: "/app/bookings/channel-sync", icon: RefreshCcw, summary: "iCal import/export, sync logs and channel holds.", phase: "foundation" },
  { key: "direct-pages", label: "Direct Booking Pages", href: "/app/bookings/direct-pages", icon: Sparkles, summary: "Public pages, checkout, confirmation and guest portal links.", phase: "foundation" },
  { key: "reports", label: "Reports", href: "/app/bookings/reports", icon: Receipt, summary: "Occupancy, ADR, RevPAR, channel mix and margin.", phase: "foundation" },
  { key: "settings", label: "Settings", href: "/app/bookings/settings", icon: Settings2, summary: "Feature flags, booking modes, legal and automation defaults.", phase: "legal" },
]
