    ...
    <div className="space-y-6">
      ...
      <div className="rounded-xl border border-slate-200 bg-slate-50 p-3 flex gap-2 text-xs text-slate-600 leading-relaxed">
        ...
        <span>
          ...
          <a href="/legal/channel-sync-disclaimer" className="text-blue-600 hover:text-blue-700">
      ...
      <section className="rounded-xl border border-slate-200 bg-white p-4">
        ...
        <div className="flex flex-col sm:flex-row gap-2 mb-3">
          ...
          <button
            ...
            onClick={addImport}
            disabled={pending}
            className="inline-flex items-center justify-center gap-1.5 rounded-lg bg-blue-600 px-3 py-2 text-sm font-medium text-white hover:bg-blue-700 disabled:opacity-60"
          >
