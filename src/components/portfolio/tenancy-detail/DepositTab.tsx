            ...
            {showDeductionForm ? (
              <div className="mt-3 flex flex-col gap-2">
                <textarea
                  ...
                  className="w-full text-sm border border-slate-200 rounded-xl px-3 py-2 text-slate-700 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500/50 resize-none"
                />
          ...
          <SectionCard className="p-5">
            ...
            {showEndConfirm ? (
              ...
              <button
                ...
                className="mt-4 w-full flex items-center justify-center gap-2 text-sm font-semibold text-white bg-blue-600 rounded-xl py-2.5 hover:bg-blue-700 transition-colors"
              >
