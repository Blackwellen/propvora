  ...
  return (
    <div className="space-y-5">
      <div className="flex items-start justify-between gap-3">
        ...
        <Link href="/property-manager/money" className="shrink-0 whitespace-nowrap flex items-center gap-1.5 text-[13px] font-semibold bg-[var(--brand)] hover:bg-[var(--brand-strong)] text-white px-3 py-2 rounded-lg transition-colors">
