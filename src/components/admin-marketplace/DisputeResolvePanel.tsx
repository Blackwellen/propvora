    ...
    <div className="rounded-xl border border-[#E2E8F0] bg-white p-3.5 space-y-3">
      <div className="flex items-center justify-between">
        <h4 className="text-xs font-bold text-slate-700 uppercase tracking-wide flex items-center gap-1.5">
          <Gavel className="w-3.5 h-3.5 text-[#2563EB]" /> Resolve dispute
        </h4>
        {onClose && (
          <button
            type="button"
      ...
      <div>
        ...
        <textarea
          ...
          className="w-full rounded-lg border border-[#E2E8F0] px-3 py-2 text-xs text-slate-800 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-[#2563EB] resize-none"
        />
      </div>
      ...
      {!confirming ? (
        <button
          ...
          className="w-full px-3 py-2 rounded-lg text-xs font-semibold text-white bg-gradient-to-b from-[#3b82f6] to-[#2563EB] hover:from-[#2f6bf0] hover:to-[#1d4ed8] transition-all"
        >
          Review resolution
        </button>
      ) : (
        <div className="space-y-2">
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              onClick={submit}
              disabled={submitting}
              className="flex-1 px-3 py-2 rounded-lg text-xs font-semibold text-white bg-gradient-to-b from-[#3b82f6] to-[#2563EB] hover:from-[#2f6bf0] hover:to-[#1d4ed8] transition-all inline-flex items-center justify-center gap-1.5 disabled:opacity-60"
            >
