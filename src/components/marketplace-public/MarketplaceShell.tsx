    ...
    <div className="min-h-screen bg-[#F7F9FC] text-[#0B1B3F] antialiased flex flex-col">
      <header className="bg-white/95 backdrop-blur border-b border-[#E2EAF6] sticky top-0 z-30">
        <div className="mx-auto max-w-[1400px] px-4 sm:px-6 h-14 flex items-center justify-between">
          <Link href="/marketplace" className="flex items-center gap-2 rounded-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--brand)]/40">
            <span className="inline-flex items-center justify-center w-7 h-7 rounded-lg bg-[var(--brand)] text-white">
              <Store className="w-4 h-4" />
            </span>
            <span className="text-[17px] font-bold tracking-tight text-[var(--brand-strong)]">Propvora</span>
          ...
          <nav className="flex items-center gap-1.5">
            ...
            <Link href="/property-manager/marketplace" className="ml-1 inline-flex items-center gap-1.5 h-9 px-3.5 rounded-xl bg-[var(--brand)] text-white text-[13px] font-semibold shadow-[0_2px_10px_rgba(37,99,235,0.30)] hover:bg-[var(--brand-strong)] transition-colors">
              Sign in
            </Link>
          </nav>
        </div>
      ...
      <footer className="border-t border-[#E2EAF6] bg-white">
        <div className="mx-auto max-w-[1400px] px-4 sm:px-6 py-7 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-4 text-[12px] text-slate-500">
            <Link href="/legal" className="hover:text-[var(--brand-strong)] transition-colors">Marketplace terms</Link>
            <Link href="/legal" className="hover:text-[var(--brand-strong)] transition-colors">Privacy</Link>
