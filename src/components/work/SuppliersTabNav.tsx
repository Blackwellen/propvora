...
const SUPPLIER_TABS = [
  { key: "overview",     label: "Overview",     href: "/property-manager/work/suppliers/overview" },
...
export function SuppliersTabNav() {
  ...
  const activeHref = SUPPLIER_TABS.find((tab) => pathname.startsWith(tab.href))?.href ?? SUPPLIER_TABS[0].href
