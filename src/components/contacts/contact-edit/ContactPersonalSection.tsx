      ...
      <div className="grid sm:grid-cols-2 gap-5">
        <div>
          ...
          <div className="relative">
            <select id="edit-contact-type" {...register("contact_type")} className="w-full h-10 pl-3 pr-8 rounded-lg text-sm border border-slate-200 bg-white appearance-none focus:outline-none focus:ring-2 focus:ring-[var(--brand)]/30 focus:border-[var(--brand)] transition-all">
        ...
        <div>
          ...
          <div className="relative">
            <select id="edit-status" {...register("status")} className="w-full h-10 pl-3 pr-8 rounded-lg text-sm border border-slate-200 bg-white appearance-none focus:outline-none focus:ring-2 focus:ring-[var(--brand)]/30 focus:border-[var(--brand)] transition-all">
                ...
                {(["person", "organisation"] as const).map(et => (
                  <button key={et} type="button" onClick={() => field.onChange(et)}
                    className={cn("px-4 py-2 rounded-lg text-sm font-medium border transition-all",
                      field.value === et ? "border-[var(--brand)] bg-[var(--brand-soft)] text-[var(--brand)]" : "border-slate-200 bg-white text-slate-600 hover:border-slate-300 hover:bg-slate-50"
                    )}>
