        ...
        {tabs.map((tab) => {
          ...
          return (
            <button
              ...
              className={cn(
                "border-b-2 -mb-px px-3.5 py-2.5 text-sm font-medium whitespace-nowrap transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--brand)]/40 motion-reduce:transition-none",
                active
              ...
              {tab.badge != null && tab.badge !== 0 && (
                <span
                  className={cn(
                    ...
                    active ? "bg-[var(--brand-soft)] text-[var(--brand)]" : "bg-slate-100 text-slate-500"
                  )}
                >
                  {tab.badge}
                </span>
