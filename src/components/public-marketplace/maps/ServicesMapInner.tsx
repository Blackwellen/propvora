              ...
              <div className="w-[232px] font-sans text-slate-900">
                ...
                <div className="relative h-[60px] w-full overflow-hidden bg-slate-200">
                  {offer.heroImage ? (
                    ...
                    <div className="flex h-full w-full items-center justify-center bg-gradient-to-br from-blue-500 to-violet-700">
                ...
                <div className="p-2.5">
                  ...
                  <div className="mt-1.5 flex flex-wrap items-center gap-1">
                    ...
                    {offer.insured && <span className="rounded-full bg-blue-50 px-1.5 py-0.5 text-[9.5px] font-bold text-blue-700">🛡 Insured</span>}
                  </div>
                  ...
                  <div className="mt-2 flex gap-1.5">
                    ...
                    <a href={`${basePath}/${offer.slug}/book`} className="flex-1 rounded-lg bg-blue-600 py-1.5 text-center text-[11px] font-bold no-underline transition-colors hover:bg-blue-700">
