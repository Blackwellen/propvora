  ...
  return (
    <button
      ...
      className={cn(
        ...
        enabled ? 'border-[var(--brand)] text-[var(--brand)]' : 'border-slate-200 text-slate-600',
      )}
    >
      <div className={cn('w-8 h-4.5 rounded-full relative transition-colors', enabled ? 'bg-[var(--brand)]' : 'bg-slate-300')}>
