    ...
    <div className="min-h-screen bg-white flex">
      ...
      >
        <div className="flex items-center gap-3 h-16 px-4 border-b border-white/8 shrink-0">
          ...
          <button onClick={() => setMobileOpen(false)} aria-label="Close menu" className="lg:hidden p-2 rounded text-white/60 hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#34d399]">
            <X className="w-5 h-5" />
          </button>
        </div>

        <nav aria-label="Affiliate portal" className="flex-1 overflow-y-auto px-2 py-4 space-y-0.5">
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#34d399] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0D1B2A]",
        ...
        <div className="shrink-0 border-t border-white/8 px-2 py-3">
          <div className="flex items-center gap-3 px-3 py-2">
            ...
            <button onClick={handleSignOut} className="p-2 rounded text-[#64748B] hover:text-red-400 transition-colors motion-reduce:transition-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#34d399]" title="Sign out" aria-label="Sign out">
      ...
      <div className="flex-1 min-w-0 lg:pl-64 flex flex-col min-h-screen">
        ...
        <main id="main-content" tabIndex={-1} aria-label="Main content" className="flex-1 min-w-0 overflow-x-hidden px-4 md:px-6 lg:px-8 py-6 lg:py-8 max-w-[1200px] mx-auto w-full focus:outline-none">
          {children}
        </main>
      </div>
    </div>
