  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="lg:hidden inline-flex items-center justify-center w-10 h-10 rounded-xl text-[#071B4D] hover:bg-[#F0F7FF] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--brand)]/40"
      >
      ...
      {kind === "supplier" && (
        <span className="hidden sm:inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-[var(--brand-soft)] text-[var(--brand)] text-[11px] font-semibold shrink-0">
          {BADGE[kind]} PORTAL
        </span>
      )}
      ...
      <Link
        href={helpHref}
        className="inline-flex items-center gap-1.5 h-10 px-3 rounded-xl bg-white border border-[#E2EAF6] text-[13px] font-semibold text-[#071B4D] hover:border-[var(--brand)]/40 hover:text-[var(--brand)] transition-colors shadow-sm shrink-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--brand)]/40"
      >
      ...
      {kind !== "supplier" && (
        <span className="hidden md:inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-[var(--brand-soft)] text-[var(--brand)] text-[11px] font-semibold shrink-0">
          {BADGE[kind]} PORTAL
        </span>
      )}

      <div className="flex items-center gap-2 h-10 pl-1 pr-2.5 rounded-full bg-white border border-[#E2EAF6] shrink-0">
        <span className="w-8 h-8 rounded-full bg-gradient-to-br from-[var(--brand)] to-[#0EA5E9] flex items-center justify-center text-white text-[11px] font-bold shrink-0">
      ...
      <form method="POST" action="/api/portal/logout">
        <button
          ...
          aria-label="Sign out"
          title="Sign out"
          className="inline-flex items-center gap-1.5 h-10 px-3 rounded-xl bg-white border border-[#E2EAF6] text-[13px] font-semibold text-slate-600 hover:text-red-600 hover:border-red-200 transition-colors shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--brand)]/40"
        >
